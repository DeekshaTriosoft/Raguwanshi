    ...
    await server_post_data(get_all_seo, fd)
      .then((Response) => {
        ...
        if (Response.data.error) {
          ...
          setsBlogData(Response.data.message.data_seo);
        }
                ...
                <div className="page-title-heading">
                  ...
                  <div>
                    ...
                    <div className="page-title-subheading">
                      Where You Can Check SEO
                    </div>
                  </div>
                </div>
                <div className="page-title-actions add_funtion_call">
                  <Link onClick={() => handleLinkClick("/SeoDashboardAdd")}>
                    <button
                      type="button"
                      className="btn-shadow mr-3 btn btn-dark"
                    >
                      <i className="fa fa-plus">&nbsp;Add SEO</i>
                    </button>
                  </Link>
                </div>
              </div>
        ...
        <div className="modal-dialog" role="document">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <p className="mb-0">
                <b>Actual Url</b>:-{SingleBlogData.actual_url}
              </p>
              <p className="mb-0">
                <b>Pretty Link</b>:-{SingleBlogData.link_url}
              </p>
              <p className="mb-0">
